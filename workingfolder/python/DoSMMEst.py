...
# + {"code_folding": [2, 14, 18, 62, 69, 117]}
@jitclass(model_data)
class DENIHybridAR:
    def __init__(self,
                 exp_para,
...
# + {"code_folding": [4, 10, 18, 21, 24, 29, 32, 37, 43, 49, 60, 78, 133, 158]}
agents_list = ['SPF','SCE']
