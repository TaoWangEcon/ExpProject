...
\begin{figure}
	\includegraphics[width=0.6\textwidth,totalheight=\0.4\textheight]{figuresDraft/Inf_ashocks_nmp.png}  
	\includegraphics[[width=0.6\textwidth,totalheight=\0.4\textheight]{figuresDraft/SPFFE_ashocks_nmp.png}  \\
	\includegraphics[width=0.5\textwidth,totalheight=\0.4\textheight]{figuresDraft/SPFDisg_ab_ashocks_nmp.png} 
	\includegraphics[width=0.5\textwidth,totalheight=\0.4\textheight]{figuresDraft/SPFVar_ab_ashocks_nmp.png}  
\end{figure}
\end{frame}
