...
Table \ref{SMM_Est_SPF} presents the SMM estimates of different model parameters. For each theory, I estimate the theory both in two-steps or jointly using expectation and inflation data. Different rows without each panel reports the estimates by using different sets of moments:forecast errors only,  forecast error and disagreement, and the two plus uncertainty.  
