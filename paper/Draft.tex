...
Standard errors are computed using the parametric bootstrapping approach as in \cite{coibion2012can} paper. 
...
Both SE and NI models predict disagreements rise after a shock and gradully converge to zero over the long-run. 
