...
%opening
\title{Rigidity of Expectation: Additional Evidence from Density Forecasts}
\author{Tao Wang}
...
In Figure \ref{ReplicateCoibionwholeperiod}, I extend the sample period to include the post-2007 period till 2019. Since PCE inflation forecast is avaiable during this period, I report results for both CPI and PCE as in previous analysis. Besides, post2007 is the period when SPF surveys density forecasts that allow us to study the dynamics of uncertainty. 
...
Similar to results for pre-2007 period, the initial response of average forecast error to future tightening shock is statistically signifcant in the first period but insignificant soon after.  Intrestingly, even though the target surprise does not impacts on inflation iteself, forecast errors do react in an inflationary manner. The magnitude of the response is as large as 25 percentage points. Rigidity models predict forecast errors shoud depend on past shocks, while this does not seem to be the case for monetary policy shocks. Forecasters reaction to monetary policy shocks apear to more efficient than for supply shocks.

Disagreements show little response to monetary policy shocks as well, with the only exception being PCE forecast with respect to path surprise.  
