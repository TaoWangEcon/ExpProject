...
How do we intereprete this finding of non-response of forecasting errror and disagreements to monetary policy shocks in the conext of rigidity models? Non-response of FE suggests that on average professional forecaters have incorporated the shock in their forecasts. Non-response of disagreements could be due to that forecasters ``agree'' on the realization of monetary policy shocks. Althouth the benchmark theory of SE and NI do not differentiate shocks, the evidence here seems to suggest that the degree of rigidity depends on the nature of the shocks. 
...
\begin{figure}[ht]
	...
	\caption{Inflation and Forecasts Moments Responses: 1984-2007}
...
In Figure \ref{ReplicateCoibionwholeperiod}, I extend the sample period to that is after 2007 to 2019. For uncertainty and PCE inflation, data is only avaiable after 2007.  This is also the period when SPF provides density forecasts that allow me to estimate uncertainty. 
...
\begin{figure}[ht]
	...
	\caption{Inflation and Forecasts Moments Responses: 1984-2019}
