...
\begin{figure}[h]\label{UnceratitnyOtherMoments}
	\centering
		\centering
	\smallskip
	\includegraphics[width=3.5cm]{figures/Inf1yf_CPIAU_varSPFCPIQ.png}
	\includegraphics[width=3.5cm]{figures/SPFCPI_FE_varSPFCPIQ.png}
	\includegraphics[width=3.5cm]{figures/CPI_disg_varSPFCPIQ.png}\\
	\smallskip
	\includegraphics[width=3.5cm]{figures/Inf1yf_PCE_varSPFPCEQ.png}
	\includegraphics[width=3.5cm]{figures/SPFPCE_FE_varSPFPCEQ.png}
	\includegraphics[width=3.5cm]{figures/PCE_disg_varSPFPCEQ.png}\\
	\smallskip	
	\includegraphics[width=3.5cm]{figures/Inf1yf_CPIAU_varSCEM.png}
	\includegraphics[width=3.5cm]{figures/SCE_FE_varSCEM.png}
	\includegraphics[width=3.5cm]{figures/Q9_disg_varSCEM.png}\\
