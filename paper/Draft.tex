...
\begin{figure}[h]\label{RevisionHist}
	\centering
	\includegraphics[width=6cm]{figures/PRCCPIMeanRev_hist.png} 
	\includegraphics[width=6cm]{figures/PRCCPIVarRev_hist.png}  \\
	\smallskip
	\includegraphics[width=6cm]{figures/PRCPCEMeanRev_hist.png} 
	\includegraphics[width=6cm]{figures/PRCPCEVarRev_hist.png}  \\
	\smallskip
		\includegraphics[width=6cm]{figures/SCEMeanRev_hist.png} 
	\includegraphics[width=6cm]{figures/SCEVarRev_hist.png}  \\
